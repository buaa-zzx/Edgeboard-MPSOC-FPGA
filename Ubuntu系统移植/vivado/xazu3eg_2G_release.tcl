...
#
# xazu3eg_2G_release.tcl: Tcl script for re-creating project 'xazu3eg_2G_release'
#
# Generated by Vivado on Sat Jan 30 16:39:16 +0800 2021
...
#
# 1. This project restoration tcl script (xazu3eg_2G_release.tcl) that was generated.
#
...
#
#    "F:/vivado_MPSOC/xazu3eg_2G_release/xazu3eg_2G_release.srcs/sources_1/bd/design_1/design_1.bd"
#    "F:/vivado_MPSOC/xazu3eg_2G_release/xazu3eg_2G_release.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#    "F:/vivado_MPSOC/xazu3eg_2G_release/xazu3eg_2G_release.srcs/sources_1/imports/xazu3eg_2G_hubrst/hw_rst.v"
#    "F:/vivado_MPSOC/xazu3eg_2G_release/xazu3eg_2G_release.srcs/constrs_1/new/pinset.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "xazu3eg_2G_release"
...
set script_file "xazu3eg_2G_release.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../vivado_MPSOC/xazu3eg_2G_release"]"

# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xczu3eg-sfvc784-1-i
...
set files [list \
 [file normalize "${origin_dir}/../../../vivado_MPSOC/xazu3eg_2G_release/xazu3eg_2G_release.srcs/sources_1/bd/design_1/design_1.bd"] \
 [file normalize "${origin_dir}/../../../vivado_MPSOC/xazu3eg_2G_release/xazu3eg_2G_release.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"] \
 [file normalize "${origin_dir}/../../../vivado_MPSOC/xazu3eg_2G_release/xazu3eg_2G_release.srcs/sources_1/imports/xazu3eg_2G_hubrst/hw_rst.v"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../../../vivado_MPSOC/xazu3eg_2G_release/xazu3eg_2G_release.srcs/sources_1/bd/design_1/design_1.bd"
...
set file "[file normalize ${origin_dir}/../../../vivado_MPSOC/xazu3eg_2G_release/xazu3eg_2G_release.srcs/constrs_1/new/pinset.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../../vivado_MPSOC/xazu3eg_2G_release/xazu3eg_2G_release.srcs/constrs_1/new/pinset.xdc"
set file [file normalize $file]
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "$orig_proj_dir/xazu3eg_2G_release.srcs/constrs_1/new/pinset.xdc" -objects $obj
set_property -name "target_part" -value "xczu3eg-sfvc784-1-i" -objects $obj
set_property -name "target_ucf" -value "$orig_proj_dir/xazu3eg_2G_release.srcs/constrs_1/new/pinset.xdc" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu3eg-sfvc784-1-i -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu3eg-sfvc784-1-i -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
